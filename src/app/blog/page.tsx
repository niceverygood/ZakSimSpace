        ...
        <PageHero
          ...
          title={
            <>
              작심스페이스의
              <br />
              <span className="text-navy-600">소식과 가이드</span>
            </>
          }
            ...
            >
              <div className="grid lg:grid-cols-[1.2fr_1fr] gap-0">
                ...
                <div className="p-7 lg:p-10 flex flex-col justify-center">
                  ...
                  <h2 className="mt-3 text-[22px] lg:text-[28px] font-extrabold text-ink-900 leading-[1.3] group-hover:text-navy-700 transition-colors">
                    {feature.title}
                  </h2>
                  <p className="mt-4 text-[14px] lg:text-[15px] text-ink-500 leading-[1.75]">
                    {feature.excerpt}
                  </p>
                  <span className="mt-6 inline-flex items-center gap-1 text-[13px] font-semibold text-navy-700">
